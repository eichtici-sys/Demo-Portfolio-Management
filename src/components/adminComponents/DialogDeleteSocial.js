...
const DialogDeleteSocial = () => {
  const { dialogDeleteSocial, handleDeleteSocial, deleteSocial, social } =
    useProfile();
  return (
    <Transition.Root show={dialogDeleteSocial} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDeleteSocial}
      >
                  ...
                  <div className="mt-2">
                    <p className="text-sm">
                      {social?.name && (
                        <span>
                          {" "}
                          {`Are your sure you want to delete the '${social.name}' ?.`}
                        </span>
                      )}
                    </p>
                  </div>
...
export default DialogDeleteSocial;
