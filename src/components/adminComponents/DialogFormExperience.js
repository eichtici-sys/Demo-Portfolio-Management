...
const DialogFormExperience = () => {
  ...
  useEffect(() => {
    if (experience?._id) {
      ...
      setFinishYear(experience.finishYear);
      return;
    }
    setId("");
    setTitle("");
  ...
  const handlesubmit = async (e) => {
    ...
    await submitExperience({ id, title, place, startYear, finishYear });
    setId("");
    setTitle("");
    setPlace("");
    setStartYear("");
  ...
  return (
    <Transition.Root show={dialogExperience} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDialogFormExperience}
      >
                  ...
                  <form className="mt-6 mb-4" onSubmit={handlesubmit}>
                    ...
                    <div className="mb-5">
                      ...
                      <input
                        ...
                        id="finishtYear"
                        className="w-full py-2 px-3 text-base border-solid border-[1px] border-[#d1d7e0] outline-none bg-transparent internIp text-slate-500 rounded-md mt-4 valid:bg-gray-100"
                        placeholder="Enter the year you finished working"
                        value={finishYear}
                    ...
                    <input
                      type="submit"
                      value={id ? "Save Changes" : "Add Experience"}
