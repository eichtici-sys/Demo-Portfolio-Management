...
const DialogDeleteEducation = () => {
  ...
  return (
    <Transition.Root show={dialogDeleteEducation} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDeleteEducation}
      >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  <div className="mt-2">
                    <p className="text-sm">
                      {education?.title && (
                        <span>
                          {`Are your sure you want to delete the '${education.title}' ?.`}
                        </span>
                      )}
                    </p>
                  </div>
...
export default DialogDeleteEducation;
