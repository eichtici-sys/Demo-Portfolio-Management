...
const DialogDeleteDescription = () => {
  ...
  return (
    <Transition.Root show={dialogDeleteDescription} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDeleteDescription}
      >
                  ...
                  <div className="mt-2">
                    <p className="text-sm">
                      {descriptionS?.description && (
                        <span>
                          {`Are your sure you want to delete the description: '${descriptionS.description}' ?.`}
                        </span>
                      )}
                    </p>
                  </div>
...
export default DialogDeleteDescription;
