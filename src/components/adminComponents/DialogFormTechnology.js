...
const DialogFormTechnology = () => {
  ...
  const handlesubmit = async (e) => {
    ...
    await submitTechnology({ id, name, project: router.query.id });
    setId("");
    setName("");
  };

  return (
    <Transition.Root show={dialogFormTechnology} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDialogTechnology}
      >
              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <form className="mt-6 mb-4" onSubmit={handlesubmit}>
                    ...
                    <input
                      type="submit"
                      value={id ? "Save Changes" : "Add Technology"}
...
export default DialogFormTechnology;
