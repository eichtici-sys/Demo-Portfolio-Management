...
const DialogFormDescriptions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await submitDescription({ id, description, service: router.query.id });
    setId("");
    setDescription("");
  };

  return (
    <Transition.Root show={dialogFormDescriptions} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDialogDescriptions}
      >
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 w-full">
              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  >
                    {id ? "Edit Description" : "Add Description"}
                  </Dialog.Title>
                  ...
                  <form className="mt-6 mb-4" onSubmit={handleSubmit}>
                    ...
                    <input
                      type="submit"
                      value={id ? "Save Changes" : "Create Description"}
...
export default DialogFormDescriptions;
