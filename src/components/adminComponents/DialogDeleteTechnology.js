...
const DialogDeleteTechnology = () => {
  ...
  return (
    <Transition.Root show={dialogDeleteTechnology} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDeleteTechnology}
      >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  <div className="mt-2">
                    <p className="text-sm">
                      {technology?.name && (
                        <span>
                          {`Are your sure you want to delete the '${technology.name}' ?.`}
                        </span>
                      )}
                    </p>
                  </div>
...
export default DialogDeleteTechnology;
