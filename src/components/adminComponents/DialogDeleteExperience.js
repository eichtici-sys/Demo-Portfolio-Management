...
const DialogDeleteExperience = () => {
  ...
  return (
    <Transition.Root show={dialogDeleteExperience} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-40 inset-0 overflow-y-auto"
        onClose={handleDeleteExperience}
      >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  <div className="mt-2">
                    <p className="text-sm">
                      {experience?.title && (
                        <span>
                          {`Are your sure you want to delete the '${experience.title}' experience ?.`}
                        </span>
                      )}
                    </p>
                  </div>
...
export default DialogDeleteExperience;
